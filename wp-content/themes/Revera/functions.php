...
function web2feel_widgets_init() {
	...
	register_sidebar(array(
		'name' => 'Footer',
		'before_widget' => '<div class="botwid col-6 col-lg-6 %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="bothead">',
		'after_title' => '</h3>',
	));	

	/* Custom Sidebar for DAVM: Events Calendar */
	register_sidebar(array(
	...
	/* Custom Sidebar for DAVM: Photo gallery for Parents page */
	register_sidebar(array(
		'name' => 'Photo Gallery Sidebar',
		'id' => 'parents-photos-sidebar',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h1 class="widget-title">',
		'after_title' => '</h1>',
	));	
	/* Custom Sidebar for DAVM: Photo gallery for Transition page */
	register_sidebar(array(
		'name' => 'Transition\'s Photo Gallery Sidebar',
		'id' => 'transition-photos-sidebar',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h1 class="widget-title">',
		'after_title' => '</h1>',
	...
	register_sidebar(array(
		'name' => 'Pre-School\'s Photo Gallery Sidebar',
		'id' => 'preschool-photos-sidebar',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h1 class="widget-title">',
		'after_title' => '</h1>',
	...
	register_sidebar(array(
		'name' => 'KG\'s Photo Gallery Sidebar',
		'id' => 'kg-photos-sidebar',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h1 class="widget-title">',
		'after_title' => '</h1>',
	...
	register_sidebar(array(
		'name' => '2ndTo5th\'s Photo Gallery Sidebar',
		'id' => 'secondtofifth-photos-sidebar',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h1 class="widget-title">',
		'after_title' => '</h1>',
	...
	register_sidebar(array(
		'name' => 'Why DAVM Gallery Sidebar',
		'id' => 'why-davm-photos-sidebar',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h1 class="widget-title">',
		'after_title' => '</h1>',
